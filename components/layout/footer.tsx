        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          <div className="space-y-10">
            <div className="flex divide-x-2 items-center gap-6">
              ...
              <div className="pl-5 flex flex-col justify-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2000 660" fill="none">
                  <path
            ...
            <p className="text-gray-400 text-sm">
              Создаем современные мобильные приложения и e-commerce платформы под ключ для вашего
              бизнеса
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li className="flex items-center space-x-2">Шайхонтохурский район, Беруний, 41</li>
              {/* <li className="flex items-center space-x-2">
